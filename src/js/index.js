...
//     let token = "i9du4830fqrk1vux";
//     let instanceId = "183761";
//     let url = `https://eu144.chat-api.com/instance${instanceId}/message?token=${token}`;
//     let data = {
//         phone: '79995253422', // Телефон получателя
//         body: `Номер телефона: ${tel.value},
//                Название продукта: ${title.textContent}
//                Цена продукта: ${slide.textContent}
//                Имя покупателя: ${name.value}`, // Сообщение
//     };
